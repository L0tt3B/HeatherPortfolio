...
const Bag = ({ onTabChange, onScrollToFooter }: BagProps) => {
  ...
  return (
    <div className="bg-yellow-900 w-full h-full rounded-lg flex flex-col justify-center items-center p-6 sm:p-4">
      ...
      <div className="flex flex-wrap justify-center font-custom text-amber-400 text-xl mt-6 sm:text-lg sm:mt-4 gap-6 sm:gap-8">
        <a className="relative group cursor-pointer text-center inline-block"
